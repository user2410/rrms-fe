...
export default function CoApplicants() {
  ...
  return (
    <Fragment>
      <CardHeader>
        <CardTitle className="text-lg">Người thuê cùng</CardTitle>
        <CardDescription>Những người cùng thuê nhà trên 18 tuổi.</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div key={index} className="border flex flex-row justify-between py-2">
              <div className="space-y-2 px-4">
                ...
                <div className="text-md font-normal flex flex-row items-center gap-2">
                  ...
                  <span>{format(new Date(field.dob), "dd/MM/yyyy")} ({(new Date()).getFullYear() - new Date(field.dob).getFullYear()} tuổi)</span>
                </div>
                <div className="text-md font-normal flex flex-row items-center gap-2">
