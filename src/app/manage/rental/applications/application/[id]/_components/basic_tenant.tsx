...
import { FaBirthdayCake, FaBriefcase, FaPhone, FaRegAddressCard } from "react-icons/fa";
          ...
          <div className="flex-1">
            <div className="w-full grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-base font-normal">{(data.application.employmentMonthlyIncome / 1e6).toFixed(1)} triệu/tháng</div>
              </div>
              <div className="space-y-2">
                <div className="flex flex-row items-center gap-2">
